...
SYS_INCLUDES := -isystem $(LIBTRANSISTOR_HOME)/pthread/include \
	...
	-isystem $(LIBTRANSISTOR_HOME)/dlfcn/include
...
LD_FLAGS := -Bsymbolic --shared --no-gc-sections --no-undefined -T $(LIBTRANSISTOR_HOME)/link.T \
	...
	-L $(LIBTRANSISTOR_HOME)/build/dlfcn/
...
LIB_DEP_DLFCN := $(LIBTRANSISTOR_HOME)/build/dlfcn/libdl.a
LIB_DEP_LIBLZMA := $(LIBTRANSISTOR_HOME)/build/xz/src/liblzma/.libs/liblzma.a
LIBTRANSISTOR_COMMON_LIB_DEPS := $(LIB_DEP_NEWLIB_LIBC) $(LIB_DEP_NEWLIB_LIBM) $(LIB_DEP_COMPILER_RT_BUILTINS) $(LIB_DEP_SDL2) $(LIB_DEP_PTHREAD) $(LIB_DEP_LIBLZMA) $(LIB_DEP_DLFCN)
...
LIBTRANSISTOR_COMMON_LDFLAGS := -lc -lm -lclang_rt.builtins-aarch64 -lSDL2 -lpthread -llzma -ldl
